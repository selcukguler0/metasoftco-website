...
export const metadata: Metadata = {
    ...
    openGraph: openGraph,
    keywords: "MetasoftCo, İletişim, İletişim Bilgileri, İletişim Formu",
        ...
        <>
            ...
            <main className=''>
                <div className='container max-w-[700px]'>
                    <h1 className='text-center text-4xl sm:text-5xl'>Bize Ulaşın! <span className='handshake-emoji'>👋</span></h1>
