...
export default function Form() {
    ...
    return (
        <form ref={formRef} action={formAction} className='w-full md:w-[700px] mx-auto mt-16'>
            ...
            <div className='mt-4 space-y-1'>
                ...
                <input required type="email" name='email' id="email" className='w-full border-2 bg-metasoftco-bg/80 hover:bg-[#a1a2a3] text-black border-gray-300 p-3' />
            </div>
            <div className='mt-4 space-y-1'>
                <label htmlFor="message">Mesajınız*</label>
                <textarea required id="message" name='message' className='w-full border-2 bg-metasoftco-bg/80 hover:bg-[#a1a2a3] text-black resize-none border-gray-300 p-3' />
            </div>
            <SubmitButton />
        </form>
    )
